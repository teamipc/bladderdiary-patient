...
heroAlt: "Uriner beaucoup après une chirurgie de la prostate est rarement 'simplement ce que c'est maintenant', c'est un problème traitable"
readingTimeMin: 16
relatedSlugs: []
citations:
...
Parmi les hommes ayant de nouveaux symptômes d'OAB après une prostatectomie radicale, seuls environ **41 pour cent** reçoivent un traitement [6]. Les autres s'entendent dire, ou se disent à eux-mêmes, que c'est juste comme ça maintenant. Ce n'est pas vrai. Il existe de vraies options. Le plus dur est de nommer le schéma et d'en parler.
