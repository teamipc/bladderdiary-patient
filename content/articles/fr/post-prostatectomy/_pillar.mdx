...
*Cet article a une visée d'information générale et ne remplace pas l'avis médical de votre équipe chirurgicale ou de votre professionnel de santé. En cas de symptômes inquiétants, contactez un clinicien. Photo : [Pascal Debrunner](https://unsplash.com/@debrupas?utm_source=bladderdiaries&utm_medium=referral) sur [Unsplash](https://unsplash.com/photos/sunbeams-stream-through-foggy-forest-trees-onto-road-MTJkXs1DfCw?utm_source=bladderdiaries&utm_medium=referral).*
