...
Maya a 38 ans, marathonienne amateur qui faisait autrefois ses longues sorties du samedi sans y penser. Depuis six mois, chaque longue course après le huitième kilomètre se transforme en chasse aux toilettes publiques. Elle était sûre que c'était le volume d'entraînement. Elle a lu des forums sur le fer, les électrolytes, le transit. Ce qu'elle n'avait pas changé, c'était son rituel d'avant course : un grand café glacé à 6 h du matin, un Coca light après. Trois jours à noter ce qu'elle buvait, quand elle courait et quand elle devait s'arrêter ont fait apparaître le schéma en vingt minutes. Les courses n'étaient pas le problème. Les 280 mg de caféine et l'édulcorant artificiel qui atterrissaient dans sa vessie quatre-vingt-dix minutes avant le premier kilomètre l'étaient. Son médecin lui avait dit « certaines personnes ont juste une vessie sensible, il faut apprendre à composer avec ». Ce n'était pas exact. C'était, en fait, réparable.

La plupart des articles sur ce sujet listent les mêmes huit aliments. Le difficile, ce n'est pas la liste. Le difficile, c'est de déterminer lesquels des huit sont vraiment les vôtres, puisque deux personnes avec le même diagnostic réagissent souvent à des aliments complètement différents. C'est la section à lire le plus attentivement.
...
Deux choses à savoir. Premièrement, un espresso est un volume de liquide assez petit pour ne pas causer l'effet de débit de remplissage ; un café filtre de 16 oz (environ 47 cl) ou un grand latte, oui. Deuxièmement, si vous êtes plus âgé et que votre corps élimine l'eau plus lentement, le café du matin peut encore produire de l'urine à l'heure du déjeuner. La raison pour laquelle « café du matin uniquement » fonctionne pour tant de gens est que cela laisse au reste de la journée le temps de s'évacuer.
...
*L'alcool est un diurétique et un frein sur les signaux cérébraux qui vous avertissent qu'une vessie est pleine.*

L'alcool agit sur la vessie de deux façons bien établies. C'est un puissant diurétique, parce qu'il supprime l'hormone antidiurétique des reins, donc la vessie se remplit rapidement. Et il atténue les signaux cérébraux qui vous indiquent que la vessie est pleine, donc les fuites surviennent avec moins d'avertissement. Les données de population sur l'alcool et la vessie hyperactive sont mixtes (certaines grandes études trouvent même qu'une consommation modérée est associée à un risque plus faible d'OAB), donc les réactions sont individuelles [3]. En pratique, beaucoup de personnes à la vessie sensible trouvent que les boissons à plus forte acidité comme le vin sont les plus provoquantes.

Si votre vessie va plus mal le lendemain matin d'une soirée vin, l'effet diurétique de l'alcool vous remplit plus vite que d'habitude, et les signaux cérébraux qui devraient vous alerter d'une vessie pleine sont émoussés.
...
Pour la **cystite interstitielle ou syndrome de la vessie douloureuse**, les aliments acides produisent souvent les réactions les plus fortes. La directive AUA CI/SVD nomme l'auto-prise en charge et les modifications comportementales, y compris les changements alimentaires, comme un Principe Clinique à discuter et à mettre en œuvre tôt dans le traitement [9].
...
(Une dernière chose. La plupart des gens qui suivent ce protocole trouvent un ou deux déclencheurs, pas huit. Le but n'est pas de vivre selon une liste d'aliments autorisés. C'est de savoir lesquels parmi deux ou trois aliments font vraiment le travail, pour que le reste de votre vie reste ouvert.)
