...
description: "La plupart des adultes urinent 6 à 8 fois par jour. Au-delà, la cause tient le plus souvent à l'une de sept choses, et un calendrier mictionnel de 3 jours permet d'identifier laquelle."
slug: "frequency"
topic: "frequency"
pageType: "pillar"
audience: ["men", "women"]
...
heroAlt: "Avoir souvent envie d'uriner est avant tout une question de moment où le liquide arrive, pas de quantité"
readingTimeMin: 13
...
- Surtout la nuit, journée correcte : nycturie, souvent d'origine rénale ; voir le [pilier sur la nycturie](/learn/nocturia)
...
Le calendrier diagnostique cela en trois jours. Si votre miction moyenne reste sous 200 mL, la capacité fait partie du tableau. La solution, c'est la **rééducation vésicale** (allonger progressivement l'intervalle entre les mictions), deuxième des quatre [exercices de rééducation vésicale](/learn/bladder-training).
...
Le diagnostic : volume d'urine du coucher à la première miction matinale, divisé par le total sur 24 heures. Au-delà de 33 % chez les personnes âgées, on évoque une polyurie nocturne [7]. Détail complet dans le [pilier sur la nycturie](/learn/nocturia).
...
1. **Démarrez un calendrier de 3 jours.** Trois colonnes pour commencer : heure, ce que vous avez bu, ce qui est sorti. Ajoutez l'urgence au jour 2, les fuites au jour 3 si nécessaire. Le [pilier sur le calendrier mictionnel](/learn/bladder-diary) explique le comment et le pourquoi ; [outils d'évaluation vésicale](/learn/bladder-diary/bladder-assessment-tools) le replace parmi les autres instruments utilisables par le patient.
2. **Avancez vos prises de liquides.** Sur une semaine, buvez 70 % de votre volume quotidien avant 15 h, en plus petites gorgées ensuite. Si vos passages diminuent, le rythme y contribuait. Gratuit, rapide, sans risque.
3. **Coupez la caféine de l'après-midi pendant une semaine.** Si vos passages se concentrent en fin d'après-midi et en soirée, la caféine est l'irritant le plus probable. Une semaine sans café d'après-midi vous dira si elle fait partie du tableau.
...
Le détail complet de la signification de chaque chiffre figure dans le [pilier sur le calendrier mictionnel](/learn/bladder-diary).

## Questions fréquentes

**Combien de fois devrais-je uriner par jour ?**
La plage typique chez l'adulte est d'environ 6 à 8 mictions diurnes [1]. Le volume total compte plus que le nombre. Huit passages à 300 mL chacun, ce n'est pas le même tableau que huit passages à 150 mL chacun.
...
**En quoi consiste la règle des 21 secondes ?**
...
**Le stress peut-il provoquer une pollakiurie ?**
...
<DiaryCta
  title="Commencez par le cadre qui fait l'essentiel du travail."
