...
Marcus a 47 ans, routier longue distance basé à Memphis, qui compte les arrêts pipi comme d'autres conducteurs comptent les kilomètres. Il avait construit ses tournées autour des relais, deux heures de plus par semaine, parfois trois. Il se disait que c'était le métier, le café, l'âge. C'est sa femme qui a suggéré le calendrier, à moitié sur le ton de la blague, après qu'il soit rentré d'une tournée à Phoenix en annonçant qu'il s'était arrêté sept fois en huit heures. Il a noté trois jours. Le tableau a montré un thé glacé d'un litre et demi pris à 10 h dans une station-service, qu'il n'avait jamais enregistré comme une seule boisson, un demi-litre repris à midi, un troisième à 15 h. Son total quotidien de liquide atteignait 4,2 litres, presque le double de ce dont il avait besoin. Sa vessie n'était pas le problème. Sa thermos l'était. On lui répétait depuis des années que c'était « un truc de prostate, il faut s'y faire ». Ce n'était pas le cas.
...
Un homme de plus de 60 ans se lève quatre fois par nuit et suppose [une HBP](/learn/bph). Le calendrier montre un jet normal, des mictions diurnes normales, une capacité maximale normale, mais plus de 40 pour cent de son urine quotidienne est fabriquée entre le coucher et la première miction matinale. La vessie va bien. Les reins font des heures supplémentaires la nuit.
...
Le déclencheur est la conversation, pas la vessie. Couper la caféine de l'après-midi résout souvent cela sans aucune autre intervention. (Ce n'est pas forcément ce qu'on a envie d'entendre. Pour la plupart des gens, pas la première fois.) Voir le guide associé sur les [aliments qui irritent la vessie](/learn/bladder-irritants/foods-that-irritate-the-bladder).
