...
heroAlt: "Urinar muito após uma cirurgia da próstata raramente é 'simplesmente assim que é', é um problema tratável"
readingTimeMin: 16
relatedSlugs: []
citations:
...
> **A resposta curta.** Urinar muito depois de uma cirurgia é normal durante a primeira ou as duas primeiras semanas. Após a maioria das operações, os soros, a anestesia e os analgésicos alteram a coordenação da bexiga, e o padrão estabiliza ao fim de cerca de dez dias. A cirurgia à próstata é a exceção. Uma frequência urinária nova ou agravada meses após o procedimento afeta cerca de um em cada três homens, e o mecanismo é genuinamente diferente dos [sintomas de HBP](/learn/bph) que existiam antes.
...
> Ingestão diária: ~800 mL (descida desde ~1500 mL antes da cirurgia). 4 meses de Kegels sem supervisão.
...
**Soros intravenosos durante o internamento.** Chega ao hospital em jejum e ligeiramente desidratado. Nas 24 a 48 horas seguintes recebe dois a quatro litros de soro fisiológico por via intravenosa. Assim que estiver de pé e a andar de novo, os rins processam esse excesso e transformam-no em bastante urina nos dias seguintes. É a resposta à pergunta frequente "o que provoca produção de urina elevada após cirurgia".
...
**Via 3, alteração do esvaziamento.** A bexiga não esvazia totalmente numa única contração coordenada, como um balão que não se consegue esvaziar de um só sopro. Aparece como esvaziamento incompleto, jato fraco ou "duplas micções", em que termina, sai da casa de banho e volta poucos minutos depois para mais.

| Via | O que está a acontecer | O que se sente | Quando aparece |
|---|---|---|---|
| **Desequilíbrio de líquidos** | Os rins produzem mais urina do que a bexiga consegue gerir | Micções de grande volume, frequentemente diluídas | Início do pós-operatório (soros); pode persistir à noite |
| **Alteração do armazenamento** | A bexiga pede para esvaziar em volumes mais pequenos | Urgência, frequência, micções pequenas | Meses após a cirurgia (o sintoma "novo") |
| **Alteração do esvaziamento** | A bexiga não esvazia numa única contração | Jato fraco, duplas micções, sensação de "não terminei" | Menos comum, mas vale a pena verificar |
...
A maior lacuna na maioria dos artigos pós-cirurgia é não darem a cronologia. Os dados são claros.

| Tempo após a cirurgia | Estado |
|---|---|
| 3 meses | ~21% de volta ao nível prévio à cirurgia [1] |
| 6 meses | ~34% relatam sintomas de armazenamento novos ou agravados [2] |
| 12 meses | Pouco mais de metade recuperados |
| 18 meses | Já aconteceu a maior parte da recuperação que vai obter [3] |
| 24+ meses | ~25% mantêm sintomas de armazenamento (tratáveis, não permanentes) |

O João, seis meses após a cirurgia, está a meio dessa tabela. Estatisticamente, as suas hipóteses de uma recuperação mais completa melhoram até aos doze e aos dezoito meses, mas só se entretanto se fizerem as coisas certas. O padrão "esperar para ver" é o que produz aqueles 25% de sintomas persistentes.
...
Depois de a próstata ser removida, a obstrução desaparece. O mecanismo da nova urgência é algo completamente diferente. Imagine: está numa reunião, foi à casa de banho há trinta minutos, e de repente a vontade volta, forte, sem aviso prévio. Antes da cirurgia conseguia aguentar uma subida lenta de "tranquilo" até "urgente" ao longo de uma hora. A versão pós-cirurgia passa do nada ao alarme em menos de um minuto. Essa queda abrupta, essa perda de tempo de aviso, é o que se sente realmente com uma bexiga hiperativa de novo. As principais explicações dadas pelos estudos urodinâmicos para isto acontecer são:
...
### O problema do subtratamento

Dos homens com novos sintomas de OAB após prostatectomia radical, apenas cerca de **41 por cento** recebem algum tratamento [6]. Aos restantes dizem, ou dizem a si próprios, que isto é o que é agora. Não é. Há opções reais. O mais difícil é nomear o padrão e perguntar sobre ele.
...
**Os Kegels em casa, sem supervisão, não funcionam melhor do que nada.** Uma meta-análise de 2022 reuniu 20 ensaios aleatorizados em 2188 homens. A reabilitação supervisionada melhorou a continência entre 12 e 25 por cento. Os Kegels não supervisionados tiveram um desempenho semelhante a não fazer terapia alguma [17].
...
- **Produção urinária diária total.** Acima de `2500 mL` aponta para uma sobreposição de desequilíbrio de líquidos.
...
<DiaryCta
  title="Regista três dias e leva o gráfico à consulta de seguimento"
  body="Anota cada bebida, cada micção com o respetivo volume, cada classificação de urgência de 0 a 10 e cada fuga. Três dias chegam para perceber se os sintomas são de produção, capacidade, esvaziamento ou alguma combinação."
/>
...
A reabilitação supervisionada do pavimento pélvico, idealmente iniciada antes da cirurgia e continuada depois, tem evidência clara. Os Kegels feitos sozinho em casa, sem supervisão, em média não rendem melhor do que não fazer terapia nenhuma. Se vai mesmo fazer este trabalho, faça-o com um fisioterapeuta de pavimento pélvico com formação.
...
- O João, o homem com quem começámos, encaixa sobretudo na Via 2 (o novo problema de armazenamento) com uma camada de Via 1 à noite (sub-hidratação a piorar tudo). O que muda o quadro para ele: um fisioterapeuta de pavimento pélvico com experiência em 4Is, regresso a uma hidratação normal (os seus 800 mL/dia fazem parte do problema) e um diário de 3 dias para levar à próxima consulta de seguimento, para que a conversa tenha dados por trás. Três passos concretos, não "conviva com isto".
