...
**Miomas uterinos e prolapso pélvico.** Miomas suficientemente grandes para pressionar a bexiga causam frequência. O limiar aproximado são seis centímetros; os miomas desse tamanho associam-se a cerca do triplo de probabilidade de sintomas do trato urinário inferior [15]. O prolapso pélvico, em que a bexiga hernia para a vagina (cistocele), provoca uma mistura diferente: incontinência de esforço nas formas ligeiras, sintomas obstrutivos (jato fraco, necessidade de pressionar manualmente, esvaziamento incompleto) nas formas avançadas.
