...
3. **O ralo não abre correctamente** (a água sai devagar ou aos solavancos).
...
<DiaryCta
  ...
  body="Registe cada bebida, cada micção com o seu volume, cada classificação de urgência e cada fuga. Os quatro números (micção média, micção máxima, total diário, quota nocturna) apontam-lhe o exercício que se ajusta."
/>
...
4. **Faça três a cinco contracções curtas e suaves do pavimento pélvico.** Pulsos rápidos, não uma contracção longa. Veremos como uma contracção do pavimento pélvico se sente realmente no quarto exercício abaixo.
...
Sim, para a maioria das pessoas com um padrão de bexiga hiperactiva, estudos bem desenhados mostram melhoria significativa às seis a doze semanas [4]. Funciona menos bem quando o problema subjacente é desequilíbrio de ingestão, alteração do esvaziamento, ou uma contribuição da coluna que não foi abordada.
