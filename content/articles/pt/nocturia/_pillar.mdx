...
faq:
  - question: "Quantas vezes por noite é demasiado?"
    answer: "Uma vez por noite é normal na maioria das idades e quase universal aos 70 anos. Duas vezes ou mais na maioria das noites é o limiar a partir do qual a noctúria é considerada clinicamente significativa e merece uma avaliação."
  - question: "Devo simplesmente parar de beber água à noite?"
    answer: "Reduzir os líquidos nas três horas antes de te deitares ajuda um pouco, em ambas as vias. Não chega por si só para corrigir uma poliúria noturna, e uma restrição severa (menos de um litro por dia no total) pode dar para o torto ao concentrar a urina e irritar o revestimento da bexiga. O diário diz-te se a tua ingestão da tarde é mesmo o problema."
  - question: "Beber menos café ajuda?"
    answer: "Muitas vezes sim, sobretudo na via vesical. A cafeína é um diurético suave, um irritante para o revestimento da bexiga e um perturbador do sono. Um ensaio de duas semanas a cortar a cafeína depois do meio-dia é um teste diagnóstico útil."
  - question: "E o álcool?"
    answer: "O álcool bloqueia a hormona antidiurética durante várias horas, por isso é que uns copos levam a uma longa noite de idas à casa de banho. Também perturba o sono profundo, por isso até uma pequena carga de líquido te acorda. Apertar a janela entre o último copo e a hora de deitar é mais eficaz do que a quantidade total."
  - question: "O meu parceiro ressona alto e eu acordo para urinar. Podem estar ligados?"
    answer: "Sim, frequentemente. Ressonar alto com pausas respiratórias observadas é a apresentação clássica da apneia obstrutiva do sono, e a apneia é um motor escondido importante da noctúria. O tratamento com CPAP reduz muito a noctúria. Vale a pena falar de um estudo do sono nos cuidados primários."
  - question: "A desmopressina é segura?"
    answer: "Para doentes cuidadosamente selecionados com poliúria noturna confirmada, seguidos por um clínico com controlos regulares de sódio no sangue, é uma opção eficaz. Sem supervisão em idosos comporta um risco real de hiponatremia perigosa. Não é um medicamento para procurar pela internet."
  - question: "Preciso mesmo de um estudo do sono?"
    answer: "Se o teu diário mostra poliúria noturna e tens algum dos seguintes: ronco alto, apneias observadas, sonolência diurna, IMC acima de 30, ou perímetro do pescoço grande, sim. O rendimento é alto e a CPAP costuma resolver a noctúria juntamente com a apneia subjacente."
citations:
...
O Frank tem 68 anos, é carpinteiro reformado que mantém um pequeno caderno na mesa de cabeceira. O caderno começou há um ano depois de a mulher lhe ter assinalado, com gentileza, que ele se levantava quatro vezes por noite e se arrastava por todas as tardes. A primeira entrada foi 1h14. A segunda, 3h02. A terceira, 4h38. A quarta, 6h11, que ele não contava verdadeiramente porque a essa altura já parecia manhã. Mostrou o caderno ao médico de família, que disse "isso é só da próstata, fala com um urologista". O urologista disse "a próstata está bem, pode ser da bexiga, experimenta este medicamento". Três semanas do medicamento não fizeram nada, porque, como um diário de 3 dias numa folha impressa veio finalmente mostrar, 47 por cento da urina diária dele estava a ser produzida entre as 23h e as 7h. A bexiga era a mensageira. Os rins eram a origem. O medicamento estava apontado ao órgão errado.

É esta a divisão que a maioria dos artigos achata. Noctúria é o termo médico para acordar do sono com necessidade de urinar e ter mesmo de urinar. A definição estrita importa, porque exclui dois padrões que parecem semelhantes mas significam coisas diferentes [1]:
...
Para o guia de ação que complementa esta visão geral (a aritmética do diário, os dois padrões, os protocolos para esta semana), vê [acordar para urinar à noite](/learn/nocturia/waking-up-to-pee-at-night).
...
- **[Hiperplasia benigna da próstata (HBP)](/learn/bph).** Em homens com mais de 50 anos, uma próstata aumentada estreita a uretra, a bexiga trabalha mais ao longo do tempo, e o músculo torna-se "irritável" e contrai-se com volumes baixos. A noctúria da HBP melhora frequentemente assim que a obstrução é tratada.
...
- **Ingestão diurna excessiva de água a sobrecarregar o sinal noturno de ADH.** Beber três a quatro litros de água ao longo do dia, frequentemente a seguir uma regra de bem-estar, pode submergir a resposta noturna da ADH. Os rins veem mais volume do que a hormona consegue reter, por isso continuam a produzir urina durante a noite mesmo num corpo mais novo com ADH intacta. O padrão parece poliúria noturna no diário, mas a causa a montante é a ingestão, não a idade.
...
- Uma meta-análise de 2020 concluiu que a noctúria implica um risco 20 por cento mais elevado de quedas e um risco 32 por cento mais elevado de fraturas em idosos, com uma relação dose-resposta clara: mais micções noturnas, mais risco [7].- Estimativas agregadas de revisões sistemáticas mostram mortalidade global mais elevada em adultos com noctúria, com um sinal mais forte naqueles que acordam três ou mais vezes [8].
