...
heroAlt: "Um caderno pautado aberto com uma caneta e lápis sobre uma secretária de madeira quente: um diário miccional de 3 dias é a ferramenta de avaliação mais útil que podes usar em casa"
readingTimeMin: 9
...
A Priya tem 45 anos, é diretora de uma escola primária que saiu da consulta com três pedaços de papel. Um questionário com pontuação que o consultório do urologista tinha entregue na sala de espera. Um modelo em branco de diário de 3 dias agrafado a ele. Um folheto impresso para uma aplicação caseira de bexiga que a irmã lhe tinha falado. Sentou-se no parque de estacionamento com os três no painel do carro e um único pensamento: "Qual é o que devo realmente fazer?" A rececionista tinha dito "começa pelo diário, mas o questionário é mais rápido". O folheto dizia que a aplicação faria tudo. Nenhum dizia que os três respondem a perguntas diferentes, e que a resposta ao problema dela ("porque é que faço 11 idas por dia") está só num deles.
...
*Este artigo destina-se a educação geral e não substitui o aconselhamento médico do teu profissional de saúde. Se sentires sintomas que te preocupam, contacta um clínico. Foto: [Clay Banks](https://unsplash.com/@claybanks?utm_source=bladderdiaries&utm_medium=referral) em [Unsplash](https://unsplash.com/photos/open-notebook-with-pen-and-pencils-on-desk-n9AaeihA9HI?utm_source=bladderdiaries&utm_medium=referral).*
