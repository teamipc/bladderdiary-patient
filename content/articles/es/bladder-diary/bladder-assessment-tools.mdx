...
heroAlt: "Un cuaderno rayado abierto con un bolígrafo y lápices sobre un escritorio de madera cálida: un diario miccional de 3 días es la herramienta de evaluación más útil que puedes usar en casa"
readingTimeMin: 9
...
Priya tiene 45 años, es directora de una escuela primaria y salió de su cita con tres papeles. Un cuestionario puntuado que la consulta de su urólogo le había entregado en la sala de espera. Una plantilla de diario de 3 días en blanco grapada al cuestionario. Un folleto impreso de una app de vejiga para casa que su hermana le había mencionado. Se sentó en el aparcamiento con los tres sobre el salpicadero y un solo pensamiento: "¿Cuál se supone que tengo que hacer en realidad?". La recepcionista había dicho "empieza con el diario, pero el cuestionario es más rápido". El folleto decía que la app lo haría todo. Ninguno de los tres decía que los tres responden a preguntas diferentes, y que la respuesta a su problema real ("¿por qué voy 11 veces al día?") está en uno solo de ellos.

La elección no es cuál es "mejor". Es qué pregunta responde cada una.
...
*Este artículo es de educación general y no sustituye la opinión médica de tu profesional sanitario. Si tienes síntomas que te preocupan, contacta con un clínico. Foto: [Clay Banks](https://unsplash.com/@claybanks?utm_source=bladderdiaries&utm_medium=referral) en [Unsplash](https://unsplash.com/photos/open-notebook-with-pen-and-pencils-on-desk-n9AaeihA9HI?utm_source=bladderdiaries&utm_medium=referral).*
