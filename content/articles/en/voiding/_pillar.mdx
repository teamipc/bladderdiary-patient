...
readingTimeMin: 9
relatedSlugs: ["weak-urine-stream", "underactive-bladder", "feeling-bladder-is-not-empty", "waking-up-to-pee-at-night", "enlarged-prostate-symptoms"]
citations:
...
*This article is for general education and is not a substitute for medical advice from your healthcare provider. If you are experiencing symptoms that worry you, contact a clinician. Photo: [Kouji Tsuru](https://unsplash.com/@pafuxu?utm_source=bladderdiaries&utm_medium=referral) on [Unsplash](https://unsplash.com/photos/a-glass-of-water-sitting-on-top-of-a-wooden-table-qsZAq8OncNc?utm_source=bladderdiaries&utm_medium=referral).*
