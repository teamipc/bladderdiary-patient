...
heroAlt: "A single water droplet hovering above a still surface as concentric ripples spread outward: an urge to pee is a wave that crests and passes in thirty to ninety seconds, not a cliff"
readingTimeMin: 9
relatedSlugs: []
citations:
...
*This article is for general education and is not a substitute for medical advice from your healthcare provider. If you are experiencing symptoms that worry you, contact a clinician. Photo: [Levi XU](https://unsplash.com/@xusanfeng?utm_source=bladderdiaries&utm_medium=referral) on [Unsplash](https://unsplash.com/photos/water-ripple-dOhJtfXJZfw?utm_source=bladderdiaries&utm_medium=referral).*
