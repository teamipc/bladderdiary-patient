...
heroAlt: "Peeing a lot after prostate surgery is rarely 'just what it is now', it's a treatable problem"
readingTimeMin: 16
relatedSlugs: []
citations:
...
> **The short answer.** Peeing a lot after surgery is normal for the first week or two. After most operations, IV fluids, anesthesia, and pain medications shift bladder coordination, and the pattern settles within ten days. Prostate surgery is the exception. New or worsening urinary frequency months after the procedure affects roughly one in three men, and the mechanism is genuinely different from the [BPH symptoms](/learn/bph) that came before.
...
John is 68, six months out from a robotic prostatectomy. His pads are mostly behind him, down from four a day to one. He's relieved about that. What he's frustrated about is the new pattern: getting up four times every night, rushing to the bathroom every two hours during the day, often passing barely a cupful. He's been doing Kegels on a YouTube schedule for four months. He's drinking less water on the theory that less in means less out. He doesn't bring it up at his urology follow-up because, he tells himself, "this is just what it is now."

He's wrong on three counts. The Kegels are doing nothing for him. The dehydration is making things worse. And "this is just what it is now" is the assumption a quarter of post-prostatectomy men carry into a treatable problem they never get treated for.

> **John's pattern, in numbers:**  
> Pad use: 4/day → 1/day. Daytime voids: every 2 hours, ~150 mL each. Nocturnal voids: 4.  
> Daily intake: ~800 mL (down from ~1,500 mL pre-surgery). 4 months of unsupervised Kegels.

The rest of this article is about how to read what's happening to John, and what changes the picture for the third of men whose post-surgery urinary symptoms get filed under "live with it" when they shouldn't.
...
The result is that "I pee a lot" after prostate surgery can mean three different things, and they often overlap. The framework that organizes this best is the **IPC 4Is functional diagnosis**: fluid imbalance, storage impairment, voiding impairment, and incontinence. For "peeing a lot," the relevant three are the first three.

**Path 1, fluid imbalance.** Your kidneys are making more urine than the bladder can comfortably manage, like trying to manage a sink filling faster than it drains. Often early after surgery from IV fluids. Sometimes persistent at night as a separate pattern.

**Path 2, storage impairment.** Your bladder is asking to be emptied at smaller and smaller volumes, like a smoke alarm that goes off when someone toasts bread. This shows up as urgency and frequency, often appearing or worsening months after surgery.

**Path 3, voiding impairment.** Your bladder isn't fully emptying in a single coordinated contraction, like a balloon you can't quite empty in one breath. This shows up as incomplete emptying, weak stream, or "double voids," where you finish, leave the toilet, and come back a few minutes later for more.

| Path | What's happening | What it feels like | When it shows up |
|---|---|---|---|
| **Fluid imbalance** | Kidneys make more urine than the bladder can manage | Big-volume voids, often dilute | Early postop (IV fluids); can persist at night |
| **Storage impairment** | Bladder wants emptying at smaller volumes | Urgency, frequency, small voids | Months after surgery (the "new" symptom) |
| **Voiding impairment** | Bladder doesn't empty in one contraction | Weak stream, double voids, "not done" feeling | Less common but worth checking |

> **Why the framework matters.** Most post-prostatectomy stories are dominated by Path 2, often with a Path 1 overlay at night. John's pattern fits this exactly: the four nighttime voids, the small daytime voids, the urgency that wasn't there before surgery. Knowing which path or paths are driving things changes the treatment, and changes which next step is worth your time.

## The recovery curve: what to expect at 3, 6, 12, 24 months

The single biggest gap in most post-surgery articles is that they don't tell you the timeline. The data is clean.

| Time after surgery | Status |
|---|---|
| 3 months | ~21% back to pre-surgery baseline [1] |
| 6 months | ~34% report new or worsened storage symptoms [2] |
| 12 months | Just over half recovered |
| 18 months | Most of the recovery you'll get has happened [3] |
| 24+ months | ~25% have lingering storage symptoms (treatable, not permanent) |

John, six months out, sits in the middle of that table. Statistically, his odds of fuller recovery improve through twelve and eighteen months, but only if the right things are being done in the meantime. The default of "wait and see" is what shows up in that 25% lingering-symptoms number.
...
This is the deepest section because this is the underdiscussed part of post-prostatectomy recovery. Roughly one in five men after open radical prostatectomy develop **de novo overactive bladder** [6]. After robotic procedures, the rate climbs to 38 percent [7][8][2]. De novo simply means new. These are men who didn't have OAB before surgery and now do. John is one of them.
...
Of men with new OAB symptoms after radical prostatectomy, only about **41 percent** receive any treatment for them [6]. The rest are told, or tell themselves, that this is just how things are now. It isn't. There are real options. The hardest part is naming the pattern and asking about it.
...
This is the section that contradicts most of what's on the internet about post-surgery Kegels. The evidence is clearer than the consensus advice suggests, and the gap between what works and what most men actually do is enormous.
...
This is exactly John's situation. Four months of YouTube Kegels is the unsupervised arm of that meta-analysis. The reason he isn't getting better isn't that he's not trying. It's that what he's trying is the version that doesn't work.
...
<DiaryCta
  title="Track three days, bring the chart to your follow-up"
  body="Log every drink, every void with its volume, every urgency rating from 0 to 10, and every leak. Three days is enough to surface whether your symptoms are about output, capacity, emptying, or some combination."
/>
...
- John, the man we started with, is mostly Path 2 (the new storage problem) with a Path 1 nighttime overlay (under-hydration making things worse). What changes the picture for him: a pelvic-floor PT with 4Is experience, return to normal hydration (his 800 mL/day is part of the problem), and a 3-day diary at his next urology visit so the conversation has data behind it. Three concrete moves, not "live with it."
